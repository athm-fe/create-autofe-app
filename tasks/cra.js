...
const scriptsFileName = cp
  .execSync(`npm pack`, { cwd: path.join(packagesDir, 'autofe-scripts') })
  .toString()
  .trim();
const scriptsPath = path.join(packagesDir, 'autofe-scripts', scriptsFileName);
...
const craScriptPath = path.join(packagesDir, 'create-autofe-app', 'index.js');
cp.execSync(
